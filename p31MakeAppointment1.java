...
public class p31MakeAppointment1
{
   public static void main(String[] args) throws IOException
   {
      ...
      String[][] timetable1 = new String[6][11];
      String[][] timetable2 = new String[6][11];
      String[][] resultTable = new String[6][11];
      int stopCount = 0;
